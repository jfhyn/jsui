	...
	$.LocationSelect = {
		...
		init: function(specs){
			...
			$.getJSON(specs.opts.data, function(data){
				...
				if(specs.opts.labels&&specs.opts.labels.length){
					$(specs.selectors.province).find("option:contains("+specs.opts.labels[0]+")").attr("selected","selected")
					$(specs.selectors.province).change()
					$(specs.selectors.city).find("option:contains("+specs.opts.labels[1]+")").attr("selected","selected")
					$(specs.selectors.city).change()
					$(specs.selectors.district).find("option:contains("+specs.opts.labels[2]+")").attr("selected","selected")
					$(specs.selectors.district).change()
				}
